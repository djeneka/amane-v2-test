...
export default function MesTakafulsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Mes <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-800 to-green-600">Takafuls</span>
            </h1>
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Gérez vos contrats d'assurance islamique et suivez vos protections
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Aucun Takaful pour le moment
          </h2>
          
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vous n'avez pas encore souscrit à des contrats Takaful. 
            Protégez-vous et votre famille avec nos solutions d'assurance islamique.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Plus size={20} />
              <span>Souscrire un Takaful</span>
            </motion.button>
