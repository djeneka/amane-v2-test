...
import { Wallet, TrendingUp, PiggyBank, Shield, BarChart3, ArrowRight, Target, Users, Star } from 'lucide-react';
...
export default function PortefeuillePage() {
  ...
  const stats = [
    ...
    { label: 'Épargnes actives', value: '3', icon: PiggyBank },
  ];
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Investissements</span>
                      <span className="font-semibold text-gray-900">60%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Épargnes</span>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        ...
                        {investment.type === 'investment' ? <TrendingUp size={24} /> : <PiggyBank size={24} />}
                      </div>
                      <div>
